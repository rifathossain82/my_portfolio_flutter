...
String blog3_des =
    'Flutter mobile app development includes Dart, which is one of the strongest features of Flutter. Dart is a programming language that uses AOT and JIT compilation for the overall performance of the application. Dart, somehow, enhances the development system with the Hot Reload function.';
...
String blog_detailsdes1 =
    'Dart was unveiled at the GOTO conference in Aarhus, Denmark, October 10–12, 2012.[13] The project was founded by Lars Bak and Kasper Lund.[14] Dart 1.0 was released on November 14, 2013';

String blog_detailsTitle2 = 'Standardization';
String blog_detailsdes2 =
...
String blog_detailsdes3 =
    'Google has introduced Flutter for native mobile app development on both Android and iOS.[30] Flutter is a mobile app SDK, complete with framework, widgets, and tools, that gives developers a way to build and deploy mobile apps, written in Dart.[31] Flutter works with Firebase[32] and other mobile app SDKs, and is open source.';

String blog_detailsTitle4 = 'DartPad';
String blog_detailsdes4 =
